...
############################# START OF EXERCISE 1 #############################
    ...
    def train_and_evaluate(bucket_name: str, vendor_name: str):
        ...
        train = pd.read_parquet(f"{datasets_path}/ to_my_place_ai/train.parquet")
        test = pd.read_parquet(f"{datasets_path}/ to_my_place_ai/test.parquet")
...
dag_model_trip_duration_easy_destiny = model_trip_duration_to_my_place_ai